...
class BaseFairseqModel(nn.Module):
    ...
    def get_normalized_probs_scriptable(
        ...
        if hasattr(self, "decoder"):
            return self.decoder.get_normalized_probs(net_output, log_probs, sample, tgt_dict)
...
class FairseqEncoderDecoderModel(BaseFairseqModel):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, **kwargs):
        ...
        # )
        #print("shape before going to encoder", src_tokens.shape)
        encoder_out = self.encoder(src_tokens, src_lengths,fanout_1,fanout_n, decoder=self.decoder)
        #print("shape before going to decoder", encoder_out['src_tokens'].shape)
        decoder_out = self.decoder(prev_output_tokens, encoder_out=encoder_out, **kwargs)
        #print("shape after going to decoder", decoder_out[1]['src_tokens'].shape)
        return decoder_out
